      ...
      <div className="mx-auto py-3">
        <div className="flex flex-col lg:flex-row justify-center items-center pb-3 border-b">
          <div className="flex space-x-8 text-black text-xl">
            <a
              href="#"
              className="hover:bg-blue-600 hover:text-white text-black p-2 rounded-full transition-colors duration-300"
            >
              <FaFacebookF />
            </a>
            <a
              href="#"
              className="hover:bg-black hover:text-white text-black p-2 rounded-full transition-colors duration-300"
            >
              <FaXTwitter />
            </a>
            <a
              href="#"
              className="hover:bg-pink-500 hover:text-white text-black p-2 rounded-full transition-colors duration-300"
            >
              <FaInstagram />
            </a>
            <a
              href="#"
              className="hover:bg-red-600 hover:text-white text-black p-2 rounded-full transition-colors duration-300"
            >
              <FaPinterestP />
            </a>
            <a
              href="#"
              className="hover:bg-orange-500 hover:text-white text-black p-2 rounded-full transition-colors duration-300"
            >
              <FaRegCommentDots />
            </a>
          </div>
        ...
        <div className="flex !flex-col sm:flex-row justify-center gap-6 border-b py-8">
          ...
          <div className="hidden xl:grid grid-cols-2 xl:grid-cols-4 gap-6 w-full px-20">
            ...
            {/* More Information */}
            <div>
              <h4 className="text-lg font-como mb-3 text-black">
                More Information
              </h4>
              <ul className="space-y-2 text-gray font-light text-sm">
                {[
            ...
            <div>
              ...
              <p className="text-xs mt-1 font-light">
                By entering your email address you are consenting to subscribe
                to marketing emails and acknowledge that you consent to our
        ...
        <div className="text-center text-xs text-gray-500 space-y-4 mt-8">
          <div className="flex flex-col sm:flex-row justify-around gap-4 sm:gap-0">
            <p className="xs text-gray font-light">
              © 2025 Moda in Pelle. All Rights Reserved.
            </p>
          ...
          <p className="xs text-gray font-light">
            MIP Online 1975 Ltd T/A Moda in Pelle Registered office 34 Roundhay
            Road, Leeds, LS7 1AB, Registered in Leeds, England
          </p>
          <p className="xs text-gray font-light">
            Company Registration Number 15714502 VAT no. 469466634
          </p>
        </div>
      </div>
    </footer>
